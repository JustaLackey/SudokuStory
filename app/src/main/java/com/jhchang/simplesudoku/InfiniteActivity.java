...
public class InfiniteActivity extends AppCompatActivity {
    ...
    //declaring gameview
    private InfiniteView infiniteView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //this time we are also passing the screen size to the infiniteView constructor
        infiniteView = new InfiniteView(this, size.x, size.y);

        //adding it to contentview
        setContentView(infiniteView);
